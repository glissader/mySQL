...
insert into `hockeyPlayers` (id, firstname, lastname, birthday, game_position, gender)
VALUES (4, 'Дмитрий', 'Алексеев', date('2002-04-07'), 'defender', 'male');

insert into `hockeyPlayers` (id, firstname, lastname, birthday, game_position, gender)
VALUES (5, 'Павел', 'Рыженьков', date('1998-03-12'), 'defender', 'male');

insert into `hockeyPlayers` (id, firstname, lastname, birthday, game_position, gender)
VALUES (6, 'Александр', 'Яковенко', date('2002-02-13'), 'defender', 'male');
...
insert into clubsInLeagues (hockeyLeagueId, hockeyClubId)
values (1, 1);
insert into clubsInLeagues (hockeyLeagueId, hockeyClubId)
values (1, 2);
insert into clubsInLeagues (hockeyLeagueId, hockeyClubId)
...
insert into playerInClub(hockeyPlayerId, hockeyClubId)
values (1, 1);
insert into playerInClub(hockeyPlayerId, hockeyClubId)
values (2, 2);
insert into playerInClub(hockeyPlayerId, hockeyClubId)
